...
<form action="LoginServlet" method="post">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Username" name="userId" id="email" required>
  ...
  <div class="container" style="background-color:#f1f1f1">
    <button type="button" class="cancelbtn" onclick="document.location=register.jsp">Register</button>
